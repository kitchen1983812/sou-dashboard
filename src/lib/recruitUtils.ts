...
export function computeNurseryStatusCrosstab(
  ...
  return buildStatusCrosstab(applicants, (a) => a.nursery, "nursery") as unknown as NurseryStatusCrosstab[];
}

export function computeAgencyStatusCrosstab(
  applicants: Applicant[]
): AgencyStatusCrosstab[] {
  return buildStatusCrosstab(applicants, (a) => a.agency, "agency") as unknown as AgencyStatusCrosstab[];
}
