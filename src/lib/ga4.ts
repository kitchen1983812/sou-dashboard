...
function toDateRanges(period: GA4Period): [
...
export async function fetchGA4Data(period: GA4Period = "30d"): Promise<GA4Data> {
  ...
  try {
    ...
    return {
      summary: { sessions, users, keyEvents, prevSessions, prevUsers, prevKeyEvents },
      channels,
      daily,
      devices,
    };
