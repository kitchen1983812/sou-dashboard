    ...
    <nav className="w-48 shrink-0 border-r border-gray-200 bg-white flex flex-col">
      ...
      <div>
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-2 text-xs font-bold text-gray-500 uppercase tracking-wider hover:bg-gray-50"
        >
          <span>集客</span>
          <svg
